...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl md:text-6xl font-bold text-center mb-12 text-primary">About Gourmet Haven</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <Image
            src="/images/restaurant-interior.jpg"
            alt="Gourmet Haven Interior"
            width={600}
            height={400}
        ...
        <div className="space-y-6">
          <p className="text-lg text-muted-foreground">
            Gourmet Haven is a luxurious dining destination that combines exquisite cuisine with a stunning ambiance. Our passionate chefs create culinary masterpieces using only the finest, locally-sourced ingredients.
          </p>
          <p className="text-lg text-muted-foreground">
